            ...
            <div>
              ...
              <div>
                <form @submit.prevent="handleSubmit">
                  ...
                  <p v-if="errorMessage" class="mt-4 text-sm text-center text-error-500">{{ errorMessage }}</p>
                </form>
                <div class="mt-5">
                  <p
        ...
        >
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <router-link to="/" class="block text-white">
                <svg viewBox="0 0 190 40" xmlns="http://www.w3.org/2000/svg" class="h-12 w-auto">
