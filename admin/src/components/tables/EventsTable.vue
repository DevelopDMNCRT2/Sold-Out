          ...
          <tr v-for="event in events" :key="event.id" class="border-t border-gray-100 dark:border-gray-800">
            ...
            <td class="px-5 py-4 sm:px-6">
              <div class="flex items-center gap-3">
                <button @click="router.push('/eventos/' + event.id + '?mode=view')" class="text-gray-500 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-400 transition-colors" title="Ver Detalles">
